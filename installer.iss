; Inno-Setup-Skript fuer die Roentgenbild-Anonymisierung
; Erzeugt einen Windows-Installer aus der zuvor gebauten dist\Roentgen-Anonymisierung.exe
;
; Voraussetzungen:
;   1) PyInstaller-Build ausgefuehrt  ->  dist\Roentgen-Anonymisierung.exe existiert
;   2) Inno Setup installiert         ->  https://jrsoftware.org/isdl.php
; Bauen:  Rechtsklick auf diese Datei -> "Compile"  ODER
;         "C:\Program Files (x86)\Inno Setup 6\ISCC.exe" installer.iss
; Ergebnis:  Output\Roentgen-Anonymisierung-Setup.exe

#define MyAppName "Roentgenbild-Anonymisierung"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Maurice Dellin"
#define MyAppExeName "Roentgen-Anonymisierung.exe"
...
OutputDir=Output
OutputBaseFilename=Roentgen-Anonymisierung-Setup
